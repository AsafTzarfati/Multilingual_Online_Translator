...
class Translator:
    ...
    def __init__(self):
        ...
        if self.src_language not in ALL_LANGUAGES:
            print(f"Sorry, the program doesn't support {self.src_language}")
            exit()
        self.trg_language = args.target_language.lower()
        if self.trg_language not in ALL_LANGUAGES:
            print(f"Sorry, the program doesn't support {self.trg_language}")
            exit()
    ...
    def display(self, num_of_words, num_of_examples):
        ...
        try:
            ...
            print("Index error while printing the examples")
    ...
    def write_to_file(self, path, num_of_words, num_of_examples):
        ...
        with open(path, 'a', encoding='utf-8') as f:
            ...
            try:
                ...
                print("Index error while writing the examples")
