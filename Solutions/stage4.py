...
ALL_LANGUAGES = ["Start", "Arabic", "German", "English", "Spanish", "French", "Hebrew", "Japanese",
...
class Translator:
    ...
    def menu(self):
        ...
        self.trg_language = ALL_LANGUAGES[int(input("Type the number of language you want to translate to:"))]
